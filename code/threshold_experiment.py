...
from CULPRIT_project.code.lib.ml_utils import get_combine_model                             # noqa
...
for i_fold, (train_index, test_index) in enumerate(kf_out.split(X_admission, Y)):       # noqa
    ...
    # cascade_norisk_model_cv_preds[test_index] = cascade_norisk_pred

    # # Store cascade predictions
    # cascade_risk_pred = model_cascade_risk["model"].predict_proba(X_test_cascade)[:, 1]     # noqa
    # cascade_risk_model_cv_preds[test_index] = cascade_risk_pred
    ...
    # results_by_ths = compute_results_several_ths(i_fold, "Combined_only_risk_cascade", Combined_only_risk_cascade_proba, Y_test, ths_range, results_by_ths)        # noqa
    # results_by_ths = compute_results_several_ths(i_fold, "Combined_only_norisk_cascade", Combined_only_norisk_cascade_proba, Y_test, ths_range, results_by_ths)    # noqa
# %%
...
# %% Savng results
save_dir = "/home/nnieto/Nico/MODS_project/CULPRIT_project/output/"
results_ths_df.to_csv(save_dir + "Results_fine_threshold_admision_10x10.csv")   # noqa
# %%
