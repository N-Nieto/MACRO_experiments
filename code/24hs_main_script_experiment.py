...
from lib.ml_utils import compute_results_several_ths, return_best_model
...
for rs in random_permutation:
    ...
    for i_fold, (train_index, test_index) in enumerate(kf_out.split(X_24, Y)):       # noqa
        ...
        for rpn in range(rnd_permutation_loop):
            ...
            results_estimators = return_best_model(i_fold, "24hs", model_24hs, rs, rpn, results_estimators)                                          # noqa
...
results_df.to_csv(save_dir+ "metrics_10x10_true_and_random_labels_24hs_v2.csv")   # noqa
results_estimators.to_csv(save_dir+ "estimators_10x10_true_and_random_labels_24hs.csv")   # noqa
results_ths_df.to_csv(save_dir + "threshold_10x10_all_models_high_24hs_v2.csv")   # noqa
